...
@Component({
  selector: 'app-customeditingrf',
  templateUrl: './customeditingrf.component.html',
  styleUrls: ['./customeditingrf.component.css'],
})
export class CustomeditingrfComponent implements OnInit {
  public gridData: any[];
